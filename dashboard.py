...
#Reading the dataset
data = pd.read_csv(r"demo_data_set.csv")
...
if chart_visual == 'Line Chart' :
    ...
    if selected_status == 'Never_Smoked':
        fig.add_trace(go.Bar(x=data.Country , y=data.Never_Smoked , name="Never_Smokes"))
    ...
    if selected_status == 'Never_Smoked':
        fig.add_trace(go.Scatter(x=data.Country , y=data.Never_Smoked , mode="markers" , name="Never_Smokes"))
